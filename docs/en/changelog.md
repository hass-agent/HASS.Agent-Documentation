...
??? danger "Breaking changes to GPU Temperature sensor"
    ...
    **It has been left present for backward compatibility reasons, however it will always return 0.**
    ...
    Please see [GPU Temperature](./reference/sensors.md/#gpu-temperature) for how you can get GPU temperature information using LibreHardwareMonitor with a WMI Query sensor.
