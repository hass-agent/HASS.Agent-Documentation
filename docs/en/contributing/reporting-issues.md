...
1.  **Navigate to the Relevant Repository:**
    ...
    - [For Documentation features/issues](https://github.com/hass-agent/HASS.Agent-Documentation/issues){: target="\_blank"}
    - [For Integration issues](https://github.com/hass-agent/HASS.Agent-Integration/issues){: target="\_blank"}
...
4.  **Provide Detailed Information:**
    ...
    - For documentation issues include permalinks by clicking the "¶" icon to the right of any title in the documentation, it will append a `#` and the title slug to the URL in your browser. You can now copy the link and place it in your github issue.
...
2. Click the "¶" icon to the right of the heading.
3. Copy the address from the top of your browser.

??? tip

    For a faster way to get a permalink you can right click the "¶" icon and select "Copy Link Address".
